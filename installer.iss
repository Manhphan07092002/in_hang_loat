...
[Setup]
AppId={{E8B4380C-7301-4D56-91E3-8E5A8F2A1234}
AppName={#MyAppName}
...
AllowNoIcons=yes
OutputDir=dist
OutputBaseFilename=PDFBatchPrinterPro_InnoSetup
...
[Files]
Source: "dist\PDFBatchPrinterPro.exe"; DestDir: "{app}"; Flags: ignoreversion
